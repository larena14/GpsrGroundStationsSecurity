...
class StationNotice : public ::inet::FieldsChunk
{
  protected:
    ...
    L3Address *neighbors = nullptr;
    size_t neighbors_arraysize = 0;
    double *rss = nullptr;
    size_t rss_arraysize = 0;
    ::omnetpp::simtime_t *timestamp = nullptr;
    size_t timestamp_arraysize = 0;
    bool *trusted = nullptr;
    size_t trusted_arraysize = 0;
  ...
  public:
    ...
    virtual const L3Address& getNeighbors(size_t k) const;
    virtual L3Address& getNeighborsForUpdate(size_t k) { handleChange();return const_cast<L3Address&>(const_cast<StationNotice*>(this)->getNeighbors(k));}
    virtual void setNeighbors(size_t k, const L3Address& neighbors);
    virtual void insertNeighbors(size_t k, const L3Address& neighbors);
    [[deprecated]] void insertNeighbors(const L3Address& neighbors) {appendNeighbors(neighbors);}
    virtual void appendNeighbors(const L3Address& neighbors);
    virtual void eraseNeighbors(size_t k);

    virtual void setRssArraySize(size_t size);
    virtual size_t getRssArraySize() const;
    virtual double getRss(size_t k) const;
    virtual void setRss(size_t k, double rss);
    virtual void insertRss(size_t k, double rss);
    [[deprecated]] void insertRss(double rss) {appendRss(rss);}
    virtual void appendRss(double rss);
    virtual void eraseRss(size_t k);

    virtual void setTimestampArraySize(size_t size);
    virtual size_t getTimestampArraySize() const;
    virtual ::omnetpp::simtime_t getTimestamp(size_t k) const;
    virtual void setTimestamp(size_t k, ::omnetpp::simtime_t timestamp);
    virtual void insertTimestamp(size_t k, ::omnetpp::simtime_t timestamp);
    [[deprecated]] void insertTimestamp(::omnetpp::simtime_t timestamp) {appendTimestamp(timestamp);}
    virtual void appendTimestamp(::omnetpp::simtime_t timestamp);
    virtual void eraseTimestamp(size_t k);

    virtual void setTrustedArraySize(size_t size);
    virtual size_t getTrustedArraySize() const;
    virtual bool getTrusted(size_t k) const;
    virtual void setTrusted(size_t k, bool trusted);
    virtual void insertTrusted(size_t k, bool trusted);
    [[deprecated]] void insertTrusted(bool trusted) {appendTrusted(trusted);}
    virtual void appendTrusted(bool trusted);
    virtual void eraseTrusted(size_t k);
};
...
/**
 * Class generated from <tt>stationGpsr/messages/Station.msg:27</tt> by opp_msgtool.
 * <pre>
...
class StationNoticeResponse : public ::inet::FieldsChunk
{
  ...
  public:
    ...
    virtual const Coord& getPosition() const;
    virtual Coord& getPositionForUpdate() { handleChange();return const_cast<Coord&>(const_cast<StationNoticeResponse*>(this)->getPosition());}
    virtual void setPosition(const Coord& position);
...
/**
 * Class generated from <tt>stationGpsr/messages/Station.msg:42</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>stationGpsr/messages/Station.msg:50</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>stationGpsr/messages/Station.msg:60</tt> by opp_msgtool.
 * <pre>
 * // vedere se eliminare timestamp
...
/**
 * Class generated from <tt>stationGpsr/messages/Station.msg:70</tt> by opp_msgtool.
 * <pre>
