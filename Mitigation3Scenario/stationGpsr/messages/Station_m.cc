...
void StationNotice::copy(const StationNotice& other)
{
    ...
    this->droneSignature = other.droneSignature;
    this->droneNonce = other.droneNonce;
}
...
void StationNotice::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->droneSignature);
    doParsimPacking(b,this->droneNonce);
}
...
void StationNotice::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->droneSignature);
    doParsimUnpacking(b,this->droneNonce);
}
...
const char * StationNotice::getDroneSignature() const
{
    return this->droneSignature.c_str();
}

void StationNotice::setDroneSignature(const char * droneSignature)
{
    handleChange();
    this->droneSignature = droneSignature;
}

uint64_t StationNotice::getDroneNonce() const
{
    return this->droneNonce;
}

void StationNotice::setDroneNonce(uint64_t droneNonce)
{
    handleChange();
    this->droneNonce = droneNonce;
}
...
unsigned int StationNoticeDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_droneSignature
        FD_ISEDITABLE,    // FIELD_droneNonce
    };
...
int StationNoticeDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "deregister") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "droneSignature") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "droneNonce") == 0) return baseIndex + 4;
...
const char *StationNoticeDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "string",    // FIELD_droneSignature
        "uint64_t",    // FIELD_droneNonce
    };
...
std::string StationNoticeDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_droneSignature: return oppstring2string(pp->getDroneSignature());
        case FIELD_droneNonce: return uint642string(pp->getDroneNonce());
        default: return "";
    }
}
...
void StationNoticeDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_droneSignature: pp->setDroneSignature((value)); break;
        case FIELD_droneNonce: pp->setDroneNonce(string2uint64(value)); break;
...
omnetpp::cValue StationNoticeDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_droneSignature: return pp->getDroneSignature();
        case FIELD_droneNonce: return (omnetpp::intval_t)(pp->getDroneNonce());
...
void StationNoticeDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_droneSignature: pp->setDroneSignature(value.stringValue()); break;
        case FIELD_droneNonce: pp->setDroneNonce(omnetpp::checked_int_cast<uint64_t>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'StationNotice'", field);
    }
}
...
void PositionResponse::copy(const PositionResponse& other)
{
    ...
    this->stationSignature = other.stationSignature;
    this->stationNonce = other.stationNonce;
    this->droneSignature = other.droneSignature;
    this->droneNonce = other.droneNonce;
}
...
void PositionResponse::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->stationSignature);
    doParsimPacking(b,this->stationNonce);
    doParsimPacking(b,this->droneSignature);
    doParsimPacking(b,this->droneNonce);
}
...
void PositionResponse::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->stationSignature);
    doParsimUnpacking(b,this->stationNonce);
    doParsimUnpacking(b,this->droneSignature);
    doParsimUnpacking(b,this->droneNonce);
}
...
const char * PositionResponse::getStationSignature() const
{
    return this->stationSignature.c_str();
}

void PositionResponse::setStationSignature(const char * stationSignature)
{
    handleChange();
    this->stationSignature = stationSignature;
}

uint64_t PositionResponse::getStationNonce() const
{
    return this->stationNonce;
}

void PositionResponse::setStationNonce(uint64_t stationNonce)
{
    handleChange();
    this->stationNonce = stationNonce;
}

const char * PositionResponse::getDroneSignature() const
{
    return this->droneSignature.c_str();
}

void PositionResponse::setDroneSignature(const char * droneSignature)
{
    handleChange();
    this->droneSignature = droneSignature;
}

uint64_t PositionResponse::getDroneNonce() const
{
    return this->droneNonce;
}

void PositionResponse::setDroneNonce(uint64_t droneNonce)
{
    handleChange();
    this->droneNonce = droneNonce;
}
...
unsigned int PositionResponseDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_stationSignature
        FD_ISEDITABLE,    // FIELD_stationNonce
        FD_ISEDITABLE,    // FIELD_droneSignature
        FD_ISEDITABLE,    // FIELD_droneNonce
    };
...
int PositionResponseDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "stationSignature") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "stationNonce") == 0) return baseIndex + 5;
    if (strcmp(fieldName, "droneSignature") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "droneNonce") == 0) return baseIndex + 7;
    return base ? base->findField(fieldName) : -1;
}
...
const char *PositionResponseDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "string",    // FIELD_stationSignature
        "uint64_t",    // FIELD_stationNonce
        "string",    // FIELD_droneSignature
        "uint64_t",    // FIELD_droneNonce
    };
...
std::string PositionResponseDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_stationSignature: return oppstring2string(pp->getStationSignature());
        case FIELD_stationNonce: return uint642string(pp->getStationNonce());
        case FIELD_droneSignature: return oppstring2string(pp->getDroneSignature());
        case FIELD_droneNonce: return uint642string(pp->getDroneNonce());
        default: return "";
    }
...
void PositionResponseDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_stationSignature: pp->setStationSignature((value)); break;
        case FIELD_stationNonce: pp->setStationNonce(string2uint64(value)); break;
        case FIELD_droneSignature: pp->setDroneSignature((value)); break;
        case FIELD_droneNonce: pp->setDroneNonce(string2uint64(value)); break;
...
omnetpp::cValue PositionResponseDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_stationSignature: return pp->getStationSignature();
        case FIELD_stationNonce: return (omnetpp::intval_t)(pp->getStationNonce());
        case FIELD_droneSignature: return pp->getDroneSignature();
        case FIELD_droneNonce: return (omnetpp::intval_t)(pp->getDroneNonce());
...
void PositionResponseDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_stationSignature: pp->setStationSignature(value.stringValue()); break;
        case FIELD_stationNonce: pp->setStationNonce(omnetpp::checked_int_cast<uint64_t>(value.intValue())); break;
        case FIELD_droneSignature: pp->setDroneSignature(value.stringValue()); break;
        case FIELD_droneNonce: pp->setDroneNonce(omnetpp::checked_int_cast<uint64_t>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'PositionResponse'", field);
    }
...
const char * S2SPositionResponse::getStationSignature() const
{
    return this->stationSignature.c_str();
}

void S2SPositionResponse::setStationSignature(const char * stationSignature)
{
    handleChange();
    this->stationSignature = stationSignature;
}

uint64_t S2SPositionResponse::getStationNonce() const
{
    return this->stationNonce;
}

void S2SPositionResponse::setStationNonce(uint64_t stationNonce)
{
    handleChange();
    this->stationNonce = stationNonce;
}

const char * S2SPositionResponse::getDroneSignature() const
{
    return this->droneSignature.c_str();
}

void S2SPositionResponse::setDroneSignature(const char * droneSignature)
{
    handleChange();
    this->droneSignature = droneSignature;
}

uint64_t S2SPositionResponse::getDroneNonce() const
{
    return this->droneNonce;
}

void S2SPositionResponse::setDroneNonce(uint64_t droneNonce)
{
    handleChange();
    this->droneNonce = droneNonce;
}
...
int S2SPositionResponseDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "stationSignature") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "stationNonce") == 0) return baseIndex + 7;
    if (strcmp(fieldName, "droneSignature") == 0) return baseIndex + 8;
    if (strcmp(fieldName, "droneNonce") == 0) return baseIndex + 9;
    return base ? base->findField(fieldName) : -1;
}
