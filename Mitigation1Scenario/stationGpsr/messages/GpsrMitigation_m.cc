//
// Generated file, do not edit! Created by opp_msgtool 6.0 from stationGpsr/messages/GpsrMitigation.msg.
//
...
uint64_t GpsrBeacon::getNonce() const
{
    return this->nonce;
}

void GpsrBeacon::setNonce(uint64_t nonce)
{
    handleChange();
    this->nonce = nonce;
}
...
void GpsrOptionDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    GpsrOption *pp = omnetpp::fromAnyPtr<GpsrOption>(object); (void)pp;
    switch (field) {
        case FIELD_routingMode: pp->setRoutingMode(static_cast<inet::GpsrForwardingMode>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'GpsrOption'", field);
    }
}
