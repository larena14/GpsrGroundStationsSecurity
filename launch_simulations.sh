...
cd /home/larena/omnetpp-6.0.3 && source setenv

cd /home/larena/omnetpp-6.0.3/samples/Attack1Definitive
...
# Sposta tutti i file JSON nella nuova cartella
cp ./results/json/*.json "$results_dir"/


echo "Plotting..."

./plot.py --areaMin ${areaMin} --areaMax ${areaMax} --malMin ${malMin} --malMax ${malMax} --nSim ${nSim} \
          --simTime ${simTime} \
           --sendMode ${sendMode}
